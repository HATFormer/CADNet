...
class SegformerHeadContraMultiHead(BaseDecodeHead):
    ...
    def forward(self, inputs):
        ...
        outs1, outs2, outs3 = self.cad_head(outs, distance)

        for idx, outs in enumerate([outs1, outs2, outs3]):
            out = self.fusion_convs[i](outs)
